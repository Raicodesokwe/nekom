...
import 'package:app/widgets/small_update_supplier.dart';
import 'package:app/widgets/small_view_supplier.dart';
...
class ViewSupplierPage extends StatelessWidget {
  final Supplier res;
  const ViewSupplierPage({Key? key, required this.res}) : super(key: key);
