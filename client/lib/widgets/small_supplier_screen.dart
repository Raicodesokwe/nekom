...
class SmallSupplierScreen extends StatefulWidget {
  const SmallSupplierScreen({Key? key}) : super(key: key);

  @override
  State<SmallSupplierScreen> createState() => _SmallSupplierScreenState();
}

class _SmallSupplierScreenState extends State<SmallSupplierScreen> {
